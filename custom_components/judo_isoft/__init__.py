"""
Custom integration to integrate judo_isoft with Home Assistant.

For more details about this integration, please refer to
https://github.com/ToSa27/ha-judo-isoft
"""
...
from .data import JudoISoftData
...
async def async_setup_entry(
    ...
    entry.runtime_data = JudoISoftData(
